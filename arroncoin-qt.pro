...
#   Bracket the code to profile with ProfileStart("arroncoin-qt.prof") and ProfileStop() and recompile
#   Run arroncoin-qt through its paces then exit
#   Analyze with:
#      pprof ./arroncoin-qt arroncoin-qt.prof
#   For a graphical view you need to: sudo apt-get install graphviz gv
#   Then run:
#      pprof --gv ./arroncoin-qt arroncoin-qt.prof
PROFILE = 0
...
FORMS += \
    ...
    src/qt/forms/getarroncoinpage.ui \
...
macx:ICON = src/qt/res/icons/arroncoin.icns
macx:TARGET = "arroncoin-Qt"
