...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. arroncoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "arroncoin",
    ...
    app.setOrganizationName("arroncoin");
    //XXX app.setOrganizationDomain("");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("arroncoin-Qt-testnet");
    else
        app.setApplicationName("arroncoin-Qt");
    ...
    try
    {
        ...
        if(AppInit2())
        {
            {
#ifdef PROFILER // For CPU profiling
                ProfilerStart("arroncoin-qt.prof");
#endif
