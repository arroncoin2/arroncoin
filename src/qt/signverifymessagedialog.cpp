    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("输入艾伦币地址（例如ATHZfUg52kfK392NNN34LMINH7nf23KLCds2）"));
    ui->signatureOut_SM->setPlaceholderText(tr("点击\“注册信息\”生成签名"));

    ui->addressIn_VM->setPlaceholderText(tr("输入艾伦币地址（例如ATHZfUg52kfK392NNN34LMINH7nf23KLCds2）"));
    ui->signatureIn_VM->setPlaceholderText(tr("进入艾伦币签名"));
#endif
