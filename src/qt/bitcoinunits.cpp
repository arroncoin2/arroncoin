...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case ARC: return QString("ARCoins");
    case mARC: return QString("Milli-ARCoins (1 / 1,000)");
    case uARC: return QString("Micro-ARCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case ARC: return 8; // 21,000,000 (# digits, without commas)
    case mARC: return 11; // 21,000,000,000
    case uARC: return 14; // 21,000,000,000,000
    default: return 0;
    }
}
