...
*/
    ...
    // Create Getarroncoin Page
    getarroncoinPage = new GetarroncoinPage();
    ...
    centralWidget->addWidget(getarroncoinPage);
...
void BitcoinGUI::lockWalletFeatures(bool lock)
{
    ...
    else
    {
        ...
        QSettings settings("arroncoin", "arroncoin-Qt");
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("艾伦概括"), this);
    overviewAction->setToolTip(tr("艾伦币钱包主页,您可以快速查看艾伦币使用情况"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("发送艾伦"), this);
    sendCoinsAction->setToolTip(tr("快速发送到您想发送的艾伦币地址"));
    ...
    */
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("接收艾伦"), this);
    receiveCoinsAction->setToolTip(tr("您个人的专属艾伦币地址，任何人可以发送到您的艾伦币地址上"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    historyAction = new QAction(QIcon(":/icons/history"), tr("交易记录"), this);
    historyAction->setToolTip(tr("您个人的艾伦币所有交易明细清单"));
    ...
    */
    ...
    // getarroncoinAction = new QAction(QIcon(":/icons/getarroncoin"), tr("艾伦家居"), this);
    // getarroncoinAction->setToolTip(tr("艾伦家居,您值得拥有"));
    // getarroncoinAction->setCheckable(true);
    // getarroncoinAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    // tabGroup->addAction(getarroncoinAction);

    forumsAction = new QAction(QIcon(":/icons/forums"), tr("简单艾伦"), this);
    forumsAction->setToolTip(tr("欢迎访问简单艾伦家居设计定制中心"));
    ...
    chatAction->setToolTip(tr("艾伦币区块连查询"));
    chatAction->setCheckable(true);
    chatAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_8));
    tabGroup->addAction(chatAction);

    blockchainAction = new QAction(QIcon(":/icons/blockchain"), tr("艾伦商城"), this);
    blockchainAction->setToolTip(tr("艾伦币家居在线商城"));
    ...
    superNETAction = new QAction(QIcon(":/icons/supernet_white"), tr("艾伦行情"), this);
    superNETAction->setToolTip(tr("登陆即可交易"));
    ...
    // connect(getarroncoinAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    // connect(getarroncoinAction, SIGNAL(triggered()), this, SLOT(gotoGetarroncoinPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/about"), tr("&艾伦币开发"), this);
    aboutAction->setToolTip(tr("显示艾伦币开发信息"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutPostAction = new QAction(QIcon(":/icons/PoSTicon"), tr("&艾伦币简介"), this);
    aboutPostAction->setToolTip(tr("艾伦币简介数据"));
    ...
    optionsAction->setToolTip(tr("修改艾伦币配置选项"));
    ...
    rescanWalletAction->setToolTip(tr("余额不正常，请点击使用扫描钱包交易数据"));
    reloadBlockchainAction = new QAction(QIcon(":/icons/blockchain-dark"), tr("&区块下载"), this);
    reloadBlockchainAction->setToolTip(tr("解压覆盖区块数据，快速同步服务"));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&更改密码"), this);
    changePassphraseAction->setToolTip(tr("更改用于钱包加密的密码"));
    lockWalletAction = new QAction(QIcon(":/icons/staking_off"), tr("&停止权益"), this);
    lockWalletAction->setToolTip(tr("停止权益锁定钱包"));
    unlockWalletAction = new QAction(QIcon(":/icons/staking_on"), tr("&开始权益"), this);
    unlockWalletAction->setToolTip(tr("开始权益解锁钱包"));
    ...
    forumAction = new QAction(QIcon(":/icons/bitcoin"), tr("艾伦币"), this);
    forumAction->setToolTip(tr("转至艾伦币论坛."));
    webAction = new QAction(QIcon(":/icons/site"), tr("官方网站"), this);
    webAction->setToolTip(tr("打开艾伦币官网."));
...
void BitcoinGUI::createToolBars()
{
    ...
    //toolbar->addAction(getarroncoinAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("艾伦币钱包") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        getarroncoinPage->setModel(walletModel);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%1 活动连接%2 到艾伦币网络").arg(count).arg(count == 1 ? "" : "s"));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        {
            progressBar->setFormat(tr("全网同步中: 剩余~%1块").arg(nRemainingBlocks).arg(nRemainingBlocks == 1 ? "" : "s"));
            progressBar->setMaximum(nTotalBlocks);
    ...
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          ...
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnitFee(BitcoinUnits::ARC, nFeeRequired));
...
void BitcoinGUI::gotoGetarroncoinPage()
{
    // getarroncoinAction->setChecked(true);
    // centralWidget->setCurrentWidget(getarroncoinPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI处理"), tr("URI不能被解析！这可以通过一个无效的arroncoin地址或畸形URI参数引起的."));
    }
...
void BitcoinGUI::checkForUpdate()
{
    ...
    if (fNewVersion)
    {
        ...
        std::string basename = GetArg("-vFileName","arroncoin-qt");
